...
function count_chars(_char, input) {
...
function part1(data) {
  ...
  var _loop_1 = function _loop_1(i) {
    ...
    var window_1 = section.split('');

    if (window_1.every(function (a) {
      return count_chars(a, section) == 1;
    })) {
      return {
        value: total_chars
      };
...
function part2(data) {
  ...
  var _loop_2 = function _loop_2(i) {
    ...
    var window_2 = section.split('');

    if (window_2.every(function (a) {
      return count_chars(a, section) == 1;
    })) {
      return {
        value: total_chars
