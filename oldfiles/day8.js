...
console.log("Total height ".concat(matrix_height, " . Total width ").concat(matrix_width));
console.log("Total calced in clear ".concat(res));
console.log("Best score ".concat(res2));
